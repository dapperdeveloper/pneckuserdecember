...
public class MyShopCartAdapter extends RecyclerView.Adapter<MyShopCartAdapter.MyViewHolder> {
    ...
    public MyShopCartAdapter(List<MainData> dataList, Activity context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.btDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((EditShopCartActivity)context).allTotalPrice = subTotalAfterProductRemove;
                ((EditShopCartActivity)context).txt_total_price.setText("Rs." +((EditShopCartActivity)context).allTotalPrice);
