...
public class MoneyOutAdapter extends RecyclerView.Adapter<MoneyOutAdapter.MyViewHolder> {

    Context context;
    List<PaymentList> transactionList;

    SessionManager sessionManager;
    public MoneyOutAdapter(Context context, List<PaymentList> transactionList) {
